...
function exampleDiagram(): DiagramModel {
  ...
  diagram.links = [
    new Connection(person.id, givenName.id, new Cardinality(1, 1), true, Anchor.BottomLeft),
    new Connection(person.id, surname.id, new Cardinality(1, 1), true, Anchor.Bottom),
    new Connection(person.id, age.id, new Cardinality(1, 1), true, Anchor.BottomRight),
