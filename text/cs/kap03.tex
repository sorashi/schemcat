...
Mohli jsme místo toho modelovat vztah jednoho rodiče s jedním dítětem, \hlcomment{ale může být užitečné nad těmito vztahy uvažovat po $n$-ticích}{je to tak?}.

Identifikátory jsme namodelovali bez rozlišení významu \hlcomment{externích a interních}{měl bych je rozlišit?} identifikátorů, protože to je vlastnost, která pro každý identifikátor vyplyne až v instanci modelu.
...
Model povoluje i identifikátory bez členů, které \hlcomment{nejsou validní}{vadí to?}.
...
Jak jednotlivé identifikátory, tak celá jejich sada u daného objektu, by měla být množina, a proto se \hlcomment{nemusí dbát}{nevím, jak to vyjádřit v UML} na pořadí a duplicity.
...
Místo toho jsou identifikátory objektů tvořeny přímo \hlcomment{dalšími objekty}{Myslím tím i vzdálenými objekty. Nevím jestli není lepší tvořit identifikátory pomocí morfismů}.
...
Jedním okruhem je funkcionalita diagramů a jejich plátna, která je u všech diagramů \hlcomment{téměř stejná}{Mám udělat případy užití pro ER, schematickou kategorii a vizualizaci schematické kategorie zvlášť?}.
