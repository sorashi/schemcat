...
Jak už bylo zmíněno, \texttt{vpd} nemá úplně stejnou strukturu jako mxfile\footnote{\url{https://drawio-app.com/extracting-the-xml-from-mxfiles/}}.
  ...
  \begin{center}
    ...
    \makebox[\textwidth]{
      \begin{tabular}{p{0.7in}lp{0.7in}p{0.7in}p{0.8in}p{0.8in}p{0.9in}}\toprule
        název                  & kategorie    & úložiště                            & interaktivní spolupráce                       & formát projektu                         & export                                           & komercializace                                                             \\ \midrule
