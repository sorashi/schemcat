...
Menu \menu{File > Publish} chybně napovídá, že se jedná o~funkci
...
\menu{File > Synchronize (Alt+Shift+S)}, které je dostupné pouze
...
Stisknutím tlačítka \menu{File > Export} se otevře
