...
z~\begin{itemize}
  ...
  \item operace skládání $\circ\colon \mathcal M\times\mathcal M \to \mathcal M$; pro každé dva morfismy $f\in\mathcal M\colon A\to B, g\in\mathcal M\colon B\to C$ musí $g\circ f\in \mathcal M$ (tranzitivita); pro tuto operaci navíc platí axiomy:
        \begin{itemize}
          \item asociativita -- pro morfismy $f\in\mathcal M\colon A\to B, g\mathcal M\colon B\to C, h\in\mathcal M\colon C\to D$ platí $h\circ (g \circ f) = (h\circ g)\circ f$,
...
\begin{figure}[!htb]
  \shorthandoff{"}
  \centering
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAEEQBfU9TXfIRQBGclVqMWbAELdeIDNjwEiZYePrNWiEAGE5fJYKKj11TVJ0ARbuJhQA5vCKgAZgCcIAWyRkQOCCQAJnNJbRAHEGoGOgAjGAYABX5lIRB3LAcACxwDEA9vYOoApABmUK02LKiQGPiklOMdDOzcnjdPH0RRf0DEcolKnSw8gq6-Eu6Ky3zRzt9ivoGLcKwAHTWAYyx3TYACVxq6hOSjFWGwbFga+LAoMuJ2-PnECb6-BggINCIggHYyK5GHAYOJjg0zmkWjkalkYHR7ogwEwGAxpuFhAB9ThPMZIHqTHqfb5EACcgOBoOicROjXO6UyMPRbCxslxLwGkwGxJ+KHJpCBDBBYJpEIE9OhuWZOixNnZhUQIV6RVqX15yH+FKFVNqotO4qhjKlgxmWP08vGizK1FuiIAtKU-Csqhttrs9pFqfV9ak2FhLlhrlwKFwgA
\begin{tikzcd}
A \arrow[d, "g"'] \arrow[r, "f"] \arrow[rd, "i\circ f" description, bend left] \arrow["1_A"', loop, distance=2em, in=215, out=145] \arrow[rd, "h\circ g" description, bend right] & B \arrow[d, "i"] \arrow["1_B"', loop, distance=2em, in=35, out=325] \\
