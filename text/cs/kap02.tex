...
Mezi tyto koncepty patří Entity Relationship (ER), schématická kategorie včetně teorie kategorií a vizuální diagram schématické kategorie.
...
Entitní typy, které nemají ani jeden interní identifikátor (musí mít tedy externí), nazýváme slabé entitní typy.
...
Schématická kategorie je zobecnění databázových schémat založená na teorii kategorií.
...
Pro naše účely se v~této práci nebudeme řídit přesně podle této originální publikace, nýbrž schémat Ichou kategorii lehce upravíme.
