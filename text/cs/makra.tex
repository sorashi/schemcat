...
\setlist[description]{partopsep=\parskip, topsep=\parskip, itemsep=0pt}
...
\DefineVerbatimEnvironment{command}{Verbatim}{listparameters=\setlength{\topsep}{1.5pt}\setlength{\partopsep}{0pt},frame=single,xleftmargin=2em}
...
\newcommand{\cardinality}[2]{(#1, #2)}
\newcommand{\zeroone}{\cardinality{\zero}{\one}}
\newcommand{\oneone}{\cardinality{\one}{\one}}
\newcommand{\zeromany}{\cardinality{\zero}{\many}}
\newcommand{\onemany}{\cardinality{\one}{\many}}
